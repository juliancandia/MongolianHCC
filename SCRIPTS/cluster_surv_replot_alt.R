...
best_K = 2 # number of classes

infile = "patient_sample_metadata_w_clustering_alt.txt"
...
risk_label = paste0(paste0("Class ",1:2)," (n=",apply(class_surv_table,1,sum),")")

plot(fit,xlim=range(0,56),col=class_color[1:best_K],xlab="Months from Diagnosis",ylab="Overall Survival (%)",conf.int=F,lty=1,lwd=3,mark.time=T,xaxt="n",yaxt="n",cex.lab=1.25)
...
outfile = "KaplanMeier_logrank_pairwise_alt.txt"
